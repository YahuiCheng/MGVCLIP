...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, tuning_prompt):
        ...
        tuning_prompt = self.tuning_layer(tuning_prompt)
        prompts = prompts + image_prompt + tuning_prompt
...
def test(args):
    ...
    state_dict = torch.load('./model_dict/epoch_9_visa_pix_test3_paper.pth', map_location=device)
